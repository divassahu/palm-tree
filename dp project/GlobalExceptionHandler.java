package com.sanjivani.exception;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> memberExceptionHandler(MemberException me,WebRequest wr) {
		MyErrorDetails err = new MyErrorDetails(me.getMessage(), wr.getDescription(false),LocalDateTime.now() );
		return new ResponseEntity<>(err, HttpStatus.FORBIDDEN);
	}
